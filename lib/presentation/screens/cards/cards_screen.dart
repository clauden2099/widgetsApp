...
class _CardsView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    /*Se usa cuando hay una lista de elementos que no caben en la pantalla
    o se desbordan pero esa lista de elementos no es propieamente una listview */
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          /*Hace que el ultimo elemento no se vea tan pegado hacía abajo y ademas
          permite hacer un poco más de scroll hacía arriba */
